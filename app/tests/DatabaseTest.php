...
class DatabaseTest extends TestCase {
    ...
    // This test's functionality is duplicated in ClassLoader. I'm leaving it here for now so it's debuggable later
    public function testCurl() {
        ...
        foreach($res as $r) {
            ...
            /* DEBUG file_put_contents("/app/class_{$i}_orig.txt", print_r($matches[1], true));*/
            ...
            /* DEBUG file_put_contents("/app/class_{$i}_parsed.txt", print_r($results, true));
            $i++;*/
