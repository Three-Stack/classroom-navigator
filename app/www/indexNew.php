...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        ...
        <form action="/Test/getClassInfo?">
          <label for="class">Classroom number:</label><br>
          <input type="text" id="class" name="class" value=""><br>
          <label for="section">Section number:</label><br>
          <input type="text" id="section" name="section" value=""><br>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <img src=app/image/CPP_Map.png alt="map of school" width="900" height="380">
